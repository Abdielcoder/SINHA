...
import '../../stripe/existingcards/stripe_existing_cards_menu_page.dart';



class ClientPaymentsCreateMenuController {
  ...
  void createCardToken() async {
    ...
    if(duplicado == true){
      ...
      Navigator.pushAndRemoveUntil<void>(
        context,
        MaterialPageRoute<void>(builder: (BuildContext context) =>  ExistingCardsMenuPage()),
        ModalRoute.withName('client/payments/stripe/existingcards/menu',),
      );
