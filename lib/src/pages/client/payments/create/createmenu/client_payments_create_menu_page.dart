...
import 'client_payments_create_menu_controller.dart';




class ClientPaymentsCreateMenuPage extends StatefulWidget {
  const ClientPaymentsCreateMenuPage({Key key}) : super(key: key);

  @override
  _ClientPaymentsCreateMenuPageState createState() => _ClientPaymentsCreateMenuPageState();
}

class _ClientPaymentsCreateMenuPageState extends State<ClientPaymentsCreateMenuPage> {

  ClientPaymentsCreateMenuController _con = new ClientPaymentsCreateMenuController();
